...
<html >
  ...
  <body style=" padding: 0;margin: 0;background: #ebecee;">
    <div class="emt-panel emt-panel-header" style="background: #002235; margin: 40px 40px; text-align: center; min-height: 200px; color: #ffffff; position: relative;">
      <div class="welcome-logo" style="display: -webkit-inline-box; font-size: 26px; height: 150px; justify-content: center; align-items: center;"><img src="http://cdn.entando.com/shield1.png" style="margin-right: 15px; margin-top: 20px;" />
        <div class="logo-name" style="margin-top: 20px;"><span>Welcome to </span><b>FORTRESS - </b><span>Bank &amp; Loan</span></div>
      </div>
      <div class="desc-text" style="font-size: 16px; margin-top: 10px; margin-left: 20px; text-align: left;">You've joined the new FORTRESS BANK &amp; LOAN services. Click to complete the account creation.</div>
    </div>
    <div class="emt-panel emt-panel-central" style="background: #ffffff; text-align: center; margin: 40px 40px; padding-top: 1px; color: #999999;">
      ...
      <div class="emt-panel-bottom" style="padding: 10px 30px;">
        ...
        <p style="text-align: left;">helpFBL@mail.com</p>
      </div>
    </div>
  </body>
</html>